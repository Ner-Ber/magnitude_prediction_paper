...
\title[Running Title]{Using past seismicity to predict the magnitude of future earthquakes \newline or \newline Does an earthquake “know” how big it’s going to be? A neural-net aided study}
...
% paradigm of earthquake  This both   . We assert that the standard hypocenter catalog alone contains sufficient information to predict future earthquake magnitudes with better-than-random accuracy. This contradicts the common view that such catalogs represent a stochastic process of earthquake magnitude occurrence (cite, perhaps Beroza etal Nat Comm 2021? their claim is that you need a ML generated catalog better predict earthquake properties). The presented results demonstrate that incorporating spatial features and seismic history into magnitude forecasting yields an information gain, thereby answering the question posed above. 
